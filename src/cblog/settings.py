...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cym5lgdbklnb.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'malitekin-blog' # please enter your s3 bucket name
